...
losers = pd.read_csv('/home/mnt/campaign_stitching/data/campaignstitch.csv')
...
def export_to_csv_callback(n_clicks):
    if n_clicks > 0:
        losers.to_csv('/home/mnt/campaign_stitching/data/campaignstitch_selected.csv', index=False)
        return 0
    else:
        raise PreventUpdate
